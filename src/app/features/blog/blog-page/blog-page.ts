...
export class BlogPage {
  ...
  constructor() {
    inject(SeoService).setData({
      title: 'Blog & Insights',
      description: 'EMDROC Travel & Tours — advisory insights on corporate travel, executive logistics, sustainable luxury, and global mobility trends for the African elite.',
      url: 'https://emdroc.com/blog',
      type: 'website',
    });
  }
}
